												...
												<div class="form-horizontal">
													<div class="control-group">
														<label class="control-label" for="form-field-1">Tipo
															de CE</label>
														<div class="controls">
															<select id="form-field-select-1" name="saeTipoColegio">
													...
													<div class="control-group">
														...
														<div class="controls">
															<select id="" name="saeEspecializacion">
																<option value="">--- Seleccione opción ---</option>
													...
													<div class="control-group">
														...
														<div class="controls">
															<input type="text" id="form-field-1"
																name="colegioTermino"
																placeholder="ingrese nombre colegio" />
														</div>
													</div>
													<div class="control-group">
														...
														<div class="controls">
															<input type="text" class="numeros" required="required"
																placeholder="ingrese cantidad solo numeros"
																name="numPostulaciones" />
														</div>
													</div>
													<div class="control-group">
														<label class="control-label" for="">Forma
															de Ingreso</label>
														<div class="controls">
															<select id=""
																name="saeFormaIngreso">
																<option value="">--- Seleccione opción ---</option>
