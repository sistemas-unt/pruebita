								...
								<div class="row-fluid">
									<form class="" name="formStep1" method="post">
											...
											<div class="step-pane active" id="step1">
												<div class="row-fluid">
													...
													<div class="span10">
																...
																<div class="control-group">
																	<div class="controls">
																		<textarea class="span10 " id="txtenfermedad"
																			name="txtenfermedad"  required="required"
																			placeholder="si sufre de alguna enfermedad presione SI para escribir la(s) emfermedad(es) de la cual padece..."><c:out value="${model.enfermdedad.nombre } "></c:out></textarea>
																	</div>
																</div>															
															</c:when>
														  <c:otherwise>
														  		<div class="control-group">
																	<div class="controls">
																		<label class="inline">¿Sufre de alguna
																			...
																			name="enfermedadradio" type="radio" title="HAGAclick"
																			onclick="deshabilitaenfermedad()" 
																			value="0" checked="checked"> <span class="lbl"> NO</span>
																		</label>
																	</div>
																</div>
														...
														<c:choose>
															<c:when test="${model.operaciones.sano==1}">
																<div class="control-group">
																	<div class="controls">
																		<label class="inline">¿A tenido alguna
																			operación?&nbsp;<input name="operacionradio"
																			type="radio" onclick="habilitaoperacion()" value="1" checked="checked">
																			<span class="lbl"> SI</span> &nbsp;&nbsp;&nbsp;
																		</label> <label class="inline"> <input
																			name="operacionradio" type="radio" title=""
																			onclick="deshabilitaoperacion()" 
																			value="0"> <span class="lbl"> NO</span>
																		</label>
																	</div>
																</div>
																...
																<div class="control-group">
																	<div class="controls">
																		<textarea class="span10" id="txtoperacion"
																			name="txtoperacion" required="required"
																			placeholder="si a tenido alguna operación presione SI para escribir la(s) operacion(es) la cual le realizaron..."><c:out value="${model.operaciones.nombre } "></c:out></textarea>
																	</div>
																</div>
																</c:when>
														  <c:otherwise>
														...
														<c:choose>
															<c:when test="${model.inmunizaciones.sano==1}">
																<div class="control-group">
																	<div class="controls">
																		<label class="inline">¿Le han realizado alguna
																			...
																			value="1" checked="checked"> <span class="lbl"> SI</span>
																			&nbsp;&nbsp;&nbsp;
																		</label> <label class="inline"> <input
																...
																<div class="control-group">
																	<div class="controls">
																		<textarea class="span10" id="txtinmunizacion"
																			name="txtinmunizacion"  required="required"
																			placeholder="si le han realizado alguna inmunización presione SI para escribir el motivo..."><c:out value="${model.inmunizaciones.nombre } "></c:out></textarea>
																	</div>
																</div>
															 </c:when>
														  <c:otherwise>
														...
														<div class="span6">
														<c:choose>
															<c:when test="${model.accidentes.sano==1}">
       																<div class="control-group">
																		<label class="control-label"></label>
																		<div class="controls">
																			<label class="inline">¿A sufrido algún
																				accidente?&nbsp; <input name="accidenteradio" 
																				type="radio" onclick="habilitaaccidente()" value="1" checked="checked"> 
																				<span class="lbl"> SI</span> &nbsp;&nbsp;&nbsp;
																			</label> <label class="inline"> <input
																				name="accidenteradio" type="radio" title="HAGAclick"
																				onclick="deshabilitaaccidente()" 
																				value="0"> <span class="lbl"> NO</span>
																		</label>
																		</div>
																	</div>
																...
																<div class="control-group">
																	<div class="controls">
																		<textarea class="span10" id="txtaccidente"
																			name="txtaccidente"  required="required"
																			placeholder="si a sufrido algún accidente presione SI para escribir..." ><c:out value="${model.accidentes.nombre } "></c:out></textarea>
																	</div>
																</div>
															...
															<div class="control-group">
																		...
																		<div class="controls">
																			<label class="inline">¿A sufrido algún
																				...
																				name="accidenteradio" type="radio" title="HAGAclick"  checked="checked"
																				onclick="deshabilitaaccidente()" 
																				value="0"> <span class="lbl"> NO</span>
																		</label>
																	</div>
														...
														<c:choose>
																...
																<div class="control-group">
																	<div class="controls">
																		<textarea class="span10" id="txtalergia"
																			name="txtalergia"  required="required"
																			placeholder="si sufre de algún tipo de alergia presione SI para escribir..."><c:out value="${model.alergias.nombre } "></c:out></textarea>
																	</div>
																</div>															
															</c:when>
														  <c:otherwise>
														 ...
														 <c:choose>
															<c:when test="${model.fichash.lentes==1}">																
																<div class="control-group">
																	<label class="control-label"></label>
																	<div class="controls">
																		<label class="inline">¿Utiliza lentes?&nbsp; <input
																			name="lentesradio" type="radio" value="1" checked="checked"> <span
																			class="lbl"> SI</span> &nbsp;&nbsp;&nbsp;
																		</label> <label class="inline"> <input
														  		...
														  		<div class="control-group">
																	...
																	<div class="controls">
																		<label class="inline">¿Utiliza lentes?&nbsp; <input
																			...
																			name="lentesradio" type="radio" title="HAGAclick" checked="checked" value="0"> <span
																			class="lbl"> NO</span>
																		</label>
																	</div>
																</div>															  
										...
										<div class="row-fluid wizard-actions">
											...
											<button
												type="submit" class="btn btn-success btn-next"
												data-last="Finish ">
