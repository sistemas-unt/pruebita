																...
																<div class="control-group">
																	...
																	<div class="controls">
																		<textarea class="span10" id="form-field-1"
																			name="txtLugarAlimentos" required="required"
																			placeholder="lugar donde toma sus alimentos. Ejemplo casa, restaurante..."></textarea>
																	</div>
																</div>
															</div>
														</div>
														...
														<div class="row-fluid">
															...
															<div class="span3">
																<div class="controls-group">
																	...
																	</label> <label> <input id="musica" type="checkbox" onclick="habilitaMusica1()"
																		value="1"> <span
																		class="lbl"> Música</span>
																	</label> <input type="text" id="txtmusica" name="listaAficiones" required="required"
