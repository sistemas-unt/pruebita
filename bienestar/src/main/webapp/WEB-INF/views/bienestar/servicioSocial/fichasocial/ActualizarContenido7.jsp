					...
					<div class="widget-box">
						...
						<div class="widget-body">
							<div class="widget-main">
								<div class="row-fluid">
									<form:form modelAttribute="socSalud">
											...
											<div class="step-pane active" id="step7">
												...
												<div class="form-horizontal">
													<div class="control-group">
														...
														<div class="controls">
															<form:select id="enfermedad"
																path="ssAcudeEnfermedad.id">
													...
													<div class="control-group">
														<label class="control-label" for="form-field-1">¿Porque
															motivos?</label>
														<div class="controls">
															<form:select id="motivo" path="ssMotivo.id">
										...
										<div class="row-fluid wizard-actions">
											...
											<button
												onClick="location.href = 'ficha_servicio_social8.htm' "
