					...
					<div class="widget-box">
						...
						<div class="widget-body">
							<div class="widget-main">
								<div class="row-fluid">
									<form:form method="POST" modelAttribute="tipovivienda">
												...
												<div class="row-fluid">
													<div class="span6">																										
														<div class="control-group">
															...
															<div class="controls">
																<form:select path="svUbicacion.id" id="ubicacionSeleccionado" name="ubicacionSeleccionado">																	
														...
														<div class="control-group">
															...
															<div class="controls">
																<form:select path="svMatConstruccion.id" id="materialSeleccionado" name="materialSeleccionado">																
														...
														<div class="control-group">
															...
															<div class="controls">
																<form:select path="svTenencia.id" id="tenenciaSeleccionada" name="tenenciaSeleccionada">																	
														...
														<div class="control-group">
															...
															<div class="controls">
																<form:select path="svTipo.id" id="tipoSeleccionado" name="tipoSeleccionado">
													...
													<div class="span6">
														<div class="control-group">
															<label class="control-label" for="form-field-1">Agua
																Potable</label>
															<div class="controls">
																<form:select path="svAguaPotable.id" id="aguaSeleccionada" name="aguaSeleccionada">																	
														...
														<div class="control-group">
															<label class="control-label" for="form-field-1">Servicios
																Higiénicos</label>
															<div class="controls">
																<form:select path="svServiciosHigienico.id" id="serviciosH" name="serviciosH">																	
														...
														<div class="control-group">
															...
															<div class="controls">
																<form:select path="svIluminacion.id" id="iluminacionSeleccionada" name="iluminacionSeleccionada">																	
